...
Intel Edison or Rasbperry Pi codebase
https://github.com/burrsutter/ti_sensortag_mqtt

Note: My Intel Edison's and Raspberry Pis are pre-configured to look for
a specific SSID, a wifi router that travels with me (HooToo), they acquire
an IP address via DNS and I use the router's console to see what IP addreses
were assigned.
